 ...
 * @package BigBulletin
 */
if (!function_exists('bigbulletin_post_carousel_widget')) :
    /**
     * Load widgets.
     *
     * @since 1.0.0
     */
    function bigbulletin_post_carousel_widget()
    {
        register_widget('BigBulletin_Post_Carousel_Widget');
    }
endif;
add_action('widgets_init', 'bigbulletin_post_carousel_widget');
// Article Widget Carousel Layout
if (!class_exists('BigBulletin_Post_Carousel_Widget')) :
    /**
     * Article Widget Carousel Layout
     *
     * @since 1.0.0
     */
    class BigBulletin_Post_Carousel_Widget extends BigBulletin_Widget_Base
    {
        /**
        ...
        {
            $opts = array(
                'classname' => 'bigbulletin_post_carousel_widget',
                'description' => esc_html__('Displays post form selected category in carousel styles', 'bigbulletin'),
            ...
            parent::__construct('bigbulletin-widget-carousel-style', esc_html__('BigBulletin: Carousel Widget', 'bigbulletin'), $opts, array(), $fields);
        }
                ...
                <div class="widget-layout widget-layout-carousel">
                    ...
                    <div class="theme-widget-content">
                        <div class="widget-slider-panel">
                            <div class="theme-widget-carousel" data-slick='{"autoplay": <?php echo esc_attr($autoplay); ?>, "rtl": <?php echo esc_attr($rtl); ?>}'>
                                <?php
