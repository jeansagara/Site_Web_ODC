(function ($) {
    ...
    var ajaxurl = bigbulletin_admin.ajax_url;
    var bigbulletinNonce = bigbulletin_admin.ajax_nonce;
    var custom_theme_file_frame;

    // Category Color
    $('#bigbulletin-cat-color').wpColorPicker();
    ...
    $('.twp-img-upload-button').click( function(){
        ...
        frame = wp.media({
            title: bigbulletin_admin.upload_image,
            button: {
            text: bigbulletin_admin.use_image
            },
    ...
    $('.twp-custom-setup').click(function(){
        ...
        var data = {
            'action': 'bigbulletin_notice_dismiss',
            '_wpnonce': bigbulletinNonce,
        };
 
        $.post(ajaxurl, data, function( response ) {

            $('.twp-bigbulletin-notice').hide();
    ...
    $('.twp-install-active').click(function(){
        ...
        $(this).closest('.twp-bigbulletin-notice').addClass('twp-installing');

        var data = {
            'action': 'bigbulletin_install_plugins',
            '_wpnonce': bigbulletinNonce,
        };
    ...
    $('.theme-recommended-plugin .recommended-plugin-status').click(function(){
        ...
        $.post(ajaxurl, data, function( response ) {
            ...
            var active = bigbulletin_admin.active
            var deactivate = bigbulletin_admin.deactivate
